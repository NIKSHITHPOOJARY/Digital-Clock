...
function settedTime() {
    ...
    if (wakeupValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(girl.png)";
    ...
    if (lunchValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(lunch.png)";
    ...
    if (napValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(evening.png)";
